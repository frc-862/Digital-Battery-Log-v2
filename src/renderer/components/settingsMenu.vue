        ...
        <div class="settingsIsland color-island" v-show="page == 'colors'">
            <div class="setting">
                ...
                <div class="color-interactable">
                    <div class="color-box c1" @click="openColorPicker(0)">
                    </div>
                </div>
            </div>
            <div class="setting">
                ...
                <div class="color-interactable">
                    <div class="color-box c2" @click="openColorPicker(1)">
                    </div>
                </div>
            </div>
            <div class="setting">
            ...
            <div class="footer">
                <i v-show="page != 'home'" @click="back()" class="fa-solid fa-left-long fa-3x"></i>
            </div>
        </div>
        <div class="color-picker" v-show="page == 'picker'">
            ...
            <div class="color-frame">
                <div class="canvas-container">
                    <canvas width="300" height="300" id="color_canvas" style="position: relative;"></canvas>
                    <div id="marker" class="marker"></div>
                </div>
                <div class="color-config">
                    <div class="sliders">
                        <canvas width="50" height="300" id="hue_canvas" style="position: relative;">
                        </canvas>
...
const syncColors = () => {
    ...
    document.documentElement.style.setProperty('--secondaryText', secondaryText);
};
</script>
<style lang="scss">
.color-picker {
